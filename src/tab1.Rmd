...
tab1func <- function(data, title) {
  ...
  tab1_crtesccrt <- print(
    CreateTableOne(
      vars = tabvars,
      data = data3 %>% filter(data == "crt" | data == "esc" & crt == "CRT") %>% mutate(data = droplevels(data)),
      strata = "data"
    ),
    smd = TRUE,
    missing = FALSE,
  ...
  tab1_crtrscrt <- print(
    CreateTableOne(
      vars = tabvars,
      data = data3 %>% filter(data == "crt" | data == "rs" & crt == "CRT") %>% mutate(data = droplevels(data)),
      strata = "data"
    ),
    smd = TRUE,
    missing = FALSE,
  ...
  tab1_crtescind <- print(
    CreateTableOne(
      vars = tabvars,
      data = data3 %>% filter(data == "crt" | data == "esc" & crt == "Indication") %>% mutate(data = droplevels(data)),
      strata = "data"
    ),
    smd = TRUE,
    missing = FALSE,
  ...
  tab1_crtrsind <- print(
    CreateTableOne(
      vars = tabvars,
      data = data3 %>% filter(data == "crt" | data == "rs" & crt == "Indication") %>% mutate(data = droplevels(data)),
      strata = "data"
    ),
    smd = TRUE,
    missing = FALSE,
  ...
  tab1 <- Reduce(
    ...
    list(tab1all, tab1_crt, tab1_esc, tab1_rs, tab1_crtesccrt, tab1_crtrscrt, tab1_crtescind, tab1_crtrsind)
  )
