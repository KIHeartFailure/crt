...
```{r barcrtind, cache=cacheon, fig.cap="Key baseline parameters for patients with CRT in CRT Survey II and indication for CRT in ESC and Swede HF. * are patients with CRT", dependson="bar"}
...
```{r barcrtindcomb, cache=cacheon, fig.cap="Key baseline parameters for patients with CRT in CRT Survey II and CRT/indication for CRT in ESC and Swede HF", dependson="bar"}
